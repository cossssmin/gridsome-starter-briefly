  ...
  <Layout>
    <main class="py-12 max-w-2xl mx-auto px-6">
      <header>
        ...
        <p class="text-gray-600 italic text-lg sm:text-2xl">Lorem ipsum subtitle &hellip;</p>
      </header>
      <article class="my-16">
        <div class="markdown">
      ...
      meta: [
        {
          key: 'description',
          name: 'description',
          content: 'Introduction to the Briefly blog starter for Gridsome.'
        },

        { property: "og:type", content: 'article' },
        { property: "og:title", content:'About' },
        { property: "og:description", content: 'Introduction to the Briefly blog starter for Gridsome.' },
        { property: "og:url", content: `${this.config.siteUrl}/about/` },
        { property: "og:image", content: `${this.config.siteUrl}/images/briefly-card.png` },

        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: 'About' },
        { name: "twitter:description", content: 'Introduction to the Briefly blog starter for Gridsome.' },
        { name: "twitter:site", content: "@cossssmin" },
        { name: "twitter:creator", content: "@cossssmin" },
        { name: "twitter:image", content: `${this.config.siteUrl}/images/briefly-card.png` },
      ],
    }
  },
  computed: {
